...
! function(a) {
	var b = {
		...
		h = ["laydate_box", "laydate_void", "laydate_click", "LayDateSkin", "./assets/js/laydate/skins/", "/laydate.css"];
	a.laydate = function(b) {
		...
		ww<=640&&(a.style.top="50%",a.style.left=0+'px',a.style.marginTop='-160px');
	}, c.follow = function(a) {
		...
		//c.use("need"), c.use(h[4] + b.defSkin, h[3]), 
