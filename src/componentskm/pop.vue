<template>
  <div class="m-pop-box">
    <div class="box">
      <div class="inner f-scroll-lt" :style="{width:width+'px'}">
        <a href="javascript:;" class="close" @click="callBack()"></a>
...
export default {
  ...
  mounted(){
    let mainDom=document.querySelector('.g-main');
