                                    ...
                                    <table class="g-in-table col-l">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span>上级推广渠道：</span>
                                                    <a :href="'#/homek/resource/promoter/'+_ajaxData.details.popDealerId" title="点击查看详情" class="details">{{_ajaxData.details.popDealerId}}</a>【名称：{{ _ajaxData.details.popDealerName||'--' }}】</td>
                                            </tr>
                                            <tr>
                                                <td><span>证件照片：</span>
                                                ...
                                                <td><span>总部推广渠道：</span>{{ _ajaxData.details.topDealerId||'--' }}【名称：{{ _ajaxData.details.topDealerName||'--' }}】</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                <td>
                                    <table class="g-in-table col-r o-clr-bd">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><span>专营号码：</span><a @click="detailsOwnNumber(_ajaxData.details.dealerId)" class="details" href="javascript:void(0)">查看详情</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>	
                                ...
                                <td>
                                    <table class="g-in-table col-l">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><span>所属商户渠道ID：</span>{{ _ajaxData2.details.dealerId }}（{{ _ajaxData2.details.companyName }}<a  class="details" @click="details(_ajaxData2.details.dealerId,1,4)" href="javascript:void(0)">详情</a>）</td>
                                                <td><span>经纬度：</span>{{ _ajaxData2.details.latitude}},{{ _ajaxData2.details.longitude}}<a href="javascript:void(0)" @click="toMap" class="details m-l">查看地图</a></td>
                                            </tr>
                                            <tr>
                                ...
                                <td>
                                    <table class="g-in-table col-r">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><span>赠送金额：</span>{{ parseFloat(_ajaxData2.details.giveMoney)/100 }}元（已使用：{{ parseFloat(_ajaxData2.details.giveMoneyUsed)/100 }}元）</td>
                                            </tr>
                                        </tbody>
                                    </table>          
                                </td>
...
export default{
    ...
    methods:{
		...
		getDetails(isBtn){//获取商户/工号基本信息
			var vm=this.$parent,type=vm.form.type,json,url,time=new Date().getTime();
		...
		getList(page){//获取第三方支付订单列表/获取用户列表
			var vm=this.$parent,type=vm.form.type,url,json;
        ...
        toMap(){
			var w=document.documentElement.clientWidth,url='',vm=this.$parent;
