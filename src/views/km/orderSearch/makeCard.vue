                    ...
                    <div class="g-search-form">
                        ...
                        <section class="form-c">
                            ...
                            <div class="row pdl">
                                ...
                                <div class="m-form-checkbox">
                                    <label><span class="checkbox"><input type="checkbox" value="true" v-model="checkAllMerchants" checked="checked" @change="BtnCheckAllPayType"><span></span></span><span class="text">全部</span></label>
                                    <label><span class="checkbox"><input type="checkbox" value="1" v-model="merchants" checked="checked"><span></span></span><span class="text">微信</span></label>
                                    <label><span class="checkbox"><input type="checkbox" value="2" v-model="merchants" checked="checked"><span></span></span><span class="text">支付宝</span></label>
                                </div>
                            </div>
