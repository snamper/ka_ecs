...
export default{
	...
	methods:{
		agree:function(){//审核同意
			...
			vm.AJAX(url,{"orderId":orderId,"result":1,"remark":'',"reason": '',"refuseReasonCode":"","auditType":auditType},function(data){
				layer.open({
					content:data.msg,
					skin: 'msg',
					time: 4,
		...
		refuse:function(obj){//审核拒绝
			...
			popIndex=layer.open({
				...
				yes:function(){
					...
					vm.AJAX(url,{"orderId":orderId,"result":2,"remark":remark,"refuseReasonCode":refuseReasonCode,"reason": reason,"stopCard":stopCard,"auditType":auditType},function(data){
						layer.open({
							content:data.msg,
							skin: 'msg',
							time: 4,
		...
		getAuditList:function(){//获取订单
			...
			vm.AJAX(url,{"type":vm.off.itemType,"auditType":auditType},function(data){
