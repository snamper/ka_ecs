  ...
  methods: {
    ...
    login: function() {
      ...
      signIn(
        {
          userId: vm.user,
          pwd: hexMD5(vm.password),
          validCode: vm.validCode,
          codeId: vm.list.codeId
        },
        function() {
          vm.load = false;
        }
        ...
        .then(res => {
          if (res.code == "200") {
            ...
            isadminYm && isadminYm.indexOf("1") > -1
              ? (vm.off.power1 = true)
              : (vm.off.power1 = false);
            isadminYm &&
            (isadminYm.indexOf("1") > -1 || isadminYm.indexOf("2") > -1)
              ? (vm.off.power2 = true)
              : (vm.off.power2 = false);
            isadminYm &&
            (isadminYm.indexOf("1") > -1 || isadminYm.indexOf("0") > -1)
              ? (vm.off.power0 = true)
              : (vm.off.power0 = false);
            isadminYm &&
            (isadminYm.indexOf("1") > -1 || isadminYm.indexOf("5") > -1)
              ? (vm.off.power5 = true)
              : (vm.off.power5 = false);
            isadminYm &&
            (isadminYm.indexOf("1") > -1 || isadminYm.indexOf("6") > -1)
              ? (vm.off.power6 = true)
              : (vm.off.power6 = false);
            ...
            IsInArray(isadmin, "0") > -1
              ? (vm.off.powerkm0 = true)
              : (vm.off.powerkm0 = false);
            IsInArray(isadmin, "1") > -1
              ? (vm.off.powerkm1 = true)
              : (vm.off.powerkm1 = false);
            IsInArray(isadmin, "2") > -1
              ? (vm.off.powerkm2 = true)
              : (vm.off.powerkm2 = false);
            IsInArray(isadmin, "3") > -1
              ? (vm.off.powerkm3 = true)
              : (vm.off.powerkm3 = false);
            IsInArray(isadmin, "4") > -1
              ? (vm.off.powerkm4 = true)
              : (vm.off.powerkm4 = false);
            IsInArray(isadmin, "5") > -1
              ? (vm.off.powerkm5 = true)
              : (vm.off.powerkm5 = false);
            IsInArray(isadmin, "6") > -1
              ? (vm.off.powerkm6 = true)
              : (vm.off.powerkm6 = false);
            IsInArray(isadmin, "7") > -1
              ? (vm.off.powerkm7 = true)
              : (vm.off.powerkm7 = false);
            IsInArray(isadmin, "11") > -1
              ? (vm.off.powerkm11 = true)
              : (vm.off.powerkm11 = false);
            IsInArray(isadmin, "21") > -1
              ? (vm.off.powerkm21 = true)
              : (vm.off.powerkm21 = false);
            IsInArray(isadmin, "31") > -1
              ? (vm.off.powerkm31 = true)
              : (vm.off.powerkm31 = false);
            IsInArray(isadmin, "41") > -1
              ? (vm.off.powerkm41 = true)
              : (vm.off.powerkm41 = false);
